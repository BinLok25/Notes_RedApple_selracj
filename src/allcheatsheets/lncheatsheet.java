package allcheatsheets;

public class lncheatsheet {
	
	/**
	 * 
	 * Here's a Cheat Sheet help your workflow and save you valuable time.

Time-Saving Shortcuts keys 📚

📝 Word: Quick Document Edits
 • Ctrl + A: Select all text
 • Ctrl + F: Find terms fast
 • Ctrl + K: Insert links
 • Ctrl + Shift + F: Change font quickly

📊Excel: Efficient Data Management
 • Ctrl + Shift + L: Apply filters
 • Ctrl + ;: Insert current date
 • Ctrl + T: Create a table
 • Alt + Shift + F1: Add a new worksheet

🗂️ PowerPoint: Smooth Presentations
 • Ctrl + M: New slide
 • F5: Start presentation
 • Ctrl + D: Duplicate slide
 • Shift + F5: Start from current slide

📨 Outlook: Email Like a Pro
 • Ctrl + N: New email
 • Ctrl + R: Reply
 • Ctrl + F: Forward
 • Ctrl + Shift + K: Mark as unread
